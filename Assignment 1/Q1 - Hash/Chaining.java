...
public int chain (int key) {
    // TODO: calculate the hash value using the given formula and return it
...
public int insertKey(int key){
    //TODO: implement the insertion into the hash table and return the number of collisions
